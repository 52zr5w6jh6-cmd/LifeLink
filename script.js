...
if(patientID === "001"){
    ...
    const qrData =
"https://52zr5w6jh6-cmd.github.io/LifeLink/hospital.html?"
+
"name=" + encodeURIComponent(profile.name)
+
"&nationality=" + encodeURIComponent(profile.nationality)
+
"&blood=" + encodeURIComponent(profile.blood)
+
"&disease=" + encodeURIComponent(profile.disease)
+
"&medicine=" + encodeURIComponent(profile.medicine)
+
"&allergy=" + encodeURIComponent(profile.allergy)
+
"&contact=" + encodeURIComponent(profile.contact)
+
